...
class PreProcessor:
    ...
    def handle_as_keyword(self, curr_query, curr_component, tokens, t: token.SQLToken, i, last_keyword_token, last_comma_index):
    ...
    # NOT IN USE
    def handle_table_name(self, curr_query, tokens, t:token.SQLToken, i, last_keyword_token, last_comma_index):
        if (t in self.tables):
            table = t
